...
// Calculates a random integer between low and high
// By Josh
...
// Translated from https://en.wikipedia.org/wiki/Bresenham%27s_line_algorithm
// by Josh
void drawLine(int x1, int y1, int x2, int y2) {
    ...
    // add a maximum number of steps to prevent game from freezing sometimes
